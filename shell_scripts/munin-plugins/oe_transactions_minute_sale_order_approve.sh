...
PROCESS="$2"
LOGFILE="$3"
$BULK_FILE $PROCESS $LOGFILE 5 | grep -B 5 approve_sale_order_for_retail | grep "DEBUG $DATABASE openerp.netsvc.rpc.request: object.execute_kw time" | awk -f $AWK_FILE
